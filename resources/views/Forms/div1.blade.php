<div class="flex items-center flex-wrap justify-between gap20 mb-27" id="div-1">
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow" type="text" placeholder="Nome sem Apelido" name="nome" tabindex="0"
            value="{{ $estudante ? $estudante->nome : '' }}" aria-required="true" required>
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow" type="text" placeholder="Apelido sem Nome" name="apelido" tabindex="0"
            value="{{ $estudante ? $estudante->apelido : '' }}" aria-required="true" required>
        <span class="error"></span>
    </fieldset>

    <fieldset class="name">
        <div class="body-title">Data de Nascimento <span class="tf-color-1">*</span></div>
        <input class="flex-grow" type="date" placeholder="" name="data_nascimento" tabindex="0"
            value="{{ $estudante ? $estudante->data_nascimento : '' }}" aria-required="true" required>
        <span class="error"></span>
    </fieldset>
    <fieldset class="name">
        ...
        <select class="flex-grow" type="" placeholder="" name="genero" tabindex="0" value=""
            ...
            <option value="M" {{ $estudante ? ($estudante->genero == 'M' ? 'selected' : '') : '' }}>Masculino</option>
            <option value="M" {{ $estudante ? ($estudante->genero == 'F' ? 'selected' : '') : '' }}>Feminino</option>
        </select>
        <span class="error"></span>
    </fieldset>
    <fieldset class="name">
