        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form class="form-search" action="{{ route('funcionario.estudantes.index') }}" method="GET">
                        <fieldset class="name">
                ...
                <a class="tf-button style-1 w208" href="{{ route('funcionario.estudante.add') }}"><i class="icon-plus"></i>Adicionar
                    </a>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="list-icon-function action">
                                                <a href="{{ route('funcionario.estudante.edit', $estudante->id) }}">
                                                    <div class="item edit">
                                                        <i class="icon-edit-3"></i>
                                                    </div>
                                                </a>
                                                <form action="{{ route('funcionario.estudante.destroy', $estudante->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('TELETE')
                                                    <div class="item text-danger delete" id="delete-{{ $estudante->id }}"
                                                        rota="dashboard/funcionario/estudantes" onclick="return confirmDeletion(event)"
                                                        dado='{{ $estudante->id }}'>
