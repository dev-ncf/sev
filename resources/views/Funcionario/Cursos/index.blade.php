        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form class="form-search" action="{{ route('funcionario.cursos.index') }}" method="GET">
                        <fieldset class="name">
                ...
                <a class="tf-button style-1 w208" href="{{ route('funcionario.curso.add') }}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-icon-function action">
                                            <a href="{{ route('funcionario.curso.edit', $curso->id) }}">
                                                <div class="item edit">
                                                    <i class="icon-edit-3"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('funcionario.curso.destroy', $curso->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('TELETE')
                                                <div class="item text-danger delete" id="delete-{{ $curso->id }}"
                                                    rota="dashboard/funcionario/cursos"
                                                    onclick="return confirmDeletion(event)" dado='{{ $curso->id }}'>
