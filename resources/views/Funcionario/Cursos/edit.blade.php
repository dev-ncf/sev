...
@section('admin-content')
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('funcionario.curso.update', $curso->id) }}"
                    ...
                    <select class="flex-grow" type="text" placeholder="Descrição" name="departamento_id" tabindex="0"
                        ...
                        @foreach ($faculdades as $faculdade)
                            <option value="{{ $faculdade->id }}"
                                {{ $faculdade->id == $curso->departamento_id ? 'selected' : '' }}>{{ $faculdade->nome }}
                            </option>
                        @endforeach
                    </select>
                </fieldset>
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Nome da Curso" name="nome" tabindex="0"
                        value="{{ $curso->nome }}" aria-required="true" required="">
                </fieldset>
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Descrição" name="descricao" tabindex="0"
                        aria-required="true" value="{{ $curso->descricao }}">
                </fieldset>
