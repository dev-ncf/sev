...
class FuuncionarioEstudanteController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('Funcionario.Estudantes.index',compact(['search','estudantes','estudante']));
    }
    ...
    public function add()
    {
        //
        $faculdades = Departamento::all();
        $cursos = Curso::where('departamento_id',Auth::user()->funcionario->departamento_id)->get();
         $estudante  = null;
        return view('Funcionario.Estudantes.add',compact(['faculdades','cursos','estudante']));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $dado = Estudante::create($dadosValidados);
             ...
             DB::commit();
             if(Auth::user()){
                return redirect()->route('funcionario.estudantes.index')->with(['success'=>'Estudante cadastrado com sucesso!','search'=>$dado->nome]);
    ...
    public function edit(Estudante $estudante)
    {
        ...
        $faculdades = Departamento::all();
        $cursos = Curso::all();
        return view('Funcionario.Estudantes.edit',compact(['estudante','faculdades','cursos']));
    }
